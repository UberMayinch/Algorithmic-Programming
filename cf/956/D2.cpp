...
int main() {
    ...
    while (t--) {
        ...
        for (auto& p : permutations) {
            ...
            if (check_permutation(p[0], p[1], p[2], n, ans, sum)) {
                found = true;
                permutation=p;
                break;
            }
